...
# train
def train(model, train_loader, val_loader, optimizer=None, epochs=400, arch ='resnet_56', steps=None, scheduler=None, run_test=True, train_model_Running=False, quant=False, name='', ratio='', device='cuda'):
    model.to(device)
