    ...
    def make_layers(self, cfg, batch_norm, ka, kw):
        ...
        for i, v in enumerate(cfg):
            if v == 'M':
                ...
                conv2d = conv2d_q(in_channels, v, ksize = 3, padding= 1, bias=False)
                cnt += 1
...
def qvgg_16_bn_A_W(filters_left, bit):
    return QVGG_A_W(num_classes=10, init_weights=True, cfg=None, filters_left=filters_left, ka=bit, kw=bit)
