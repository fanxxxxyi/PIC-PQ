...
class PICPQ:
    ...
    def model_compress(self, name, long_ft, target=-1, arch =''):
        ...
        model_qt2 = qvgg_16_bn_A_W(filters_left=sparse_channel, bit=bit).cuda()
        ...
        bops_counter = eval('BOPsCounterVGG')(self.model, self.rank_type, num_cls=10, rankPath=args.rankPath, device=self.device)
...
if __name__ == "__main__":
    ...
    filter_pruner = eval('FilterPrunerVGG')(basemodel, 'Rank', num_cls=10, rankPath=args.rankPath, device=device)
